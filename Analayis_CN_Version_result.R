...
##Comparing dry, wet and obs for 1850-2100, cn version
##
##################################################################################
##################################################################################
...
title.list <- read.table(paste(getwd(), "/drought/outputs/AmaFACE1_D_GDA_AMB_OBS_OBS.csv", sep=""), 
...
##################################################
obsDF <- read.table(paste(getwd(), "/drought/outputs/AmaFACE1_D_GDA_AMB_OBS_OBS.csv", sep=""), 
                    sep=",", skip = 3, header=T)
...
dryDF <- read.table(paste(getwd(), "/drought/outputs/AmaFACE1_D_GDA_AMB_DRY_OBS.csv", sep=""), 
                    sep=",", skip = 3, header=T)
...
wetDF <- read.table(paste(getwd(), "/drought/outputs/AmaFACE1_D_GDA_AMB_WET_OBS.csv", sep=""), 
                    sep=",", skip = 3, header=T)
...
pdf(paste(getwd(), "/drought_analysis/all_plots/annual_pattern_cn_dry_wet_obs.pdf",sep=""))
...
##################################################
obsDFele <- read.table(paste(getwd(), "/drought/outputs/AmaFACE1_D_GDA_ELE_OBS_OBS.csv", sep=""), 
                    sep=",", skip = 3, header=T)
...
dryDFele <- read.table(paste(getwd(), "/drought/outputs/AmaFACE1_D_GDA_ELE_DRY_OBS.csv", sep=""), 
                    sep=",", skip = 3, header=T)
...
wetDFele <- read.table(paste(getwd(), "/drought/outputs/AmaFACE1_D_GDA_ELE_WET_OBS.csv", sep=""), 
                    sep=",", skip = 3, header=T)
...
pdf(paste(getwd(), "/drought_analysis/all_plots/annual_pattern_cn_dry_wet_obs_ele.pdf",sep=""))
...
pdf(paste(getwd(), "/drought_analysis/all_plots/annual_pattern_cn_ele_vs_amb_obs.pdf",sep=""))
...
pdf(paste(getwd(), "/drought_analysis/all_plots/annual_pattern_cn_ele_vs_amb_dry.pdf",sep=""))
...
pdf(paste(getwd(), "/drought_analysis/all_plots/annual_pattern_cn_ele_vs_amb_wet.pdf",sep=""))
